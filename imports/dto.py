...
class CitizenDTO:
    def __init__(self, citizen=None, relatives=None):
        ...
        self.relatives = relatives if relatives is not None else [c.citizen_id for c in citizen.relatives.all()] if citizen else None
